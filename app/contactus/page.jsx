...
export default function Component() {
  ...
  return (
    ...
    </AspectRatio><h5 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
        ENERGY AND FUEL USERS’ ASSOCIATION OF INDIA
      </h5>
      <p className="font-normal text-gray-700 dark:text-gray-400">
	  4B-1, JP TOWERS<br/>
7/2, NUNGAMBAKKAM HIGH ROAD<br/>
CHENNAI – 600 034.<br/>
TAMIL NADU. INDIA<br/>
PHONE : 91-44-28278604<br/>
FAX : 91-44-28205553<br/>
		</p>
    </Card>
